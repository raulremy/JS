...
class Signo{
    ...
    determinaSigno(grados){
        if(grados >= this.cuspide && grados < this.cuspide+30){
            console.log(`La persona pertenece al signo de %s`, this.nombre)    
        }
    }
}
...
// Quiero algo mas abstracto, funcion que compare cuspides entre anterior y siguiente y determine
...
let grados = parseInt(prompt("Ingrese los grados, para determinar el signo: "))
