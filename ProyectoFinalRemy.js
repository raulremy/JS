...
// Se despliega el objeto buscado, sea un Signo o un Planeta
...
divsignos = document.getElementById("divSignos")

// Se recorren los signos
document.getElementById("btnSignos").addEventListener("click", () => {
    fetch ("signos.json", {
        method: 'GET'
    })
    ...
    .then(data => {
        console.log(data)
        for (signo of data) {
            console.log(signo._id)
            divSignos.innerHTML += `
                <div id="${signo._indice}"> 
                    <h2>Signo: ${signo.nombre} </h2>
                    <p>Polaridad: ${signo.polaridad} </p>
                    <p>Cualidad: ${signo.cualidad} </p>
                    <p>Elemento: ${signo.elemento} </p>
                    <p>Regente: ${signo.regente} </p>
                    <p>Descripcion: ${signo.descripcion} </p>
                </div>
                ` 
            signs.push(signo)
        }
...
divPlanetas = document.getElementById("divPlanetas")
    ...
    .then(data => {
        ...
        for (planeta of data) {
            ...
            divPlanetas.innerHTML += `
                <div id="${planeta._indice}"> 
                    <h2>Planeta: ${planeta.nombre} </h2>
                    <p>Descripcion: ${planeta.descripcion} </p>
                    <p>Rige a: ${planeta.rige} </p>
                </div>
                ` 
